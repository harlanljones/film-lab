...
export type Play={id:string;name:string;duration:number;category:string;defenseLook:string;tags:string[];notes:string;tracks:PlayerTrack[];beats:Beat[];summary:CoachingSummary};
