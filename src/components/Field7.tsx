...
export function Field7({ tracks = [], time, selectedTrackId, onPlayerSelect, onPointSelect, onWaypointSelect, onWaypointMove, className = '', children, 'aria-label': ariaLabel = '7-on-7 play field' }: Field7Props) {
